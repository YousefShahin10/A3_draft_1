...
public class IslandCreationTest {
    ...
    @Test
    public void testInsideMethodInside() {
        List<Vertex> vertices = new ArrayList<>();
        vertices.add(new Vertex(0, 0));
        vertices.add(new Vertex(1, 1));
        vertices.add(new Vertex(2, 2));
        Circle circle = new Circle(2, 1, 1);
        int result = circle.inside(vertices);
        assertEquals(-1, result);
    }

    @Test
    public void testInsideMethodOutside() {
        List<Vertex> vertices = new ArrayList<>();
        vertices.add(new Vertex(0, 0));
    ...
    @Test
    public void testInsideMethodMixed() {
        List<Vertex> vertices = new ArrayList<>();
        vertices.add(new Vertex(0, 0));
        vertices.add(new Vertex(1, 1));
        vertices.add(new Vertex(3, 3));
    ...
    @Test
    public void testInsideRectMethodInside() {
        List<Vertex> vertices = new ArrayList<>();
        vertices.add(new Vertex(0, 0));
        vertices.add(new Vertex(1, 1));
        vertices.add(new Vertex(2, 2));
        Rectangle rectangle = new Rectangle(2, 2, 1, 1);
        int result = rectangle.inside(vertices);
        assertEquals(-1, result);
    }

    @Test
    public void testInsideRectMethodOutside() {
        List<Vertex> vertices = new ArrayList<>();
        vertices.add(new Vertex(0, 0));
        vertices.add(new Vertex(3, 3));
        Rectangle rectangle = new Rectangle(2, 2, 1, 1);
    ...
    @Test
    public void testInsideRectMethodMixed() {
        List<Vertex> vertices = new ArrayList<>();
        vertices.add(new Vertex(0, 0));
        vertices.add(new Vertex(1, 1));
        vertices.add(new Vertex(3, 3));
